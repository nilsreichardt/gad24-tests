...
public class BinomialHeapTest {
    ...
    void exceptionTest() {
        assertThrows(RuntimeException.class, () -> heap.min(),
                "Please throw an exception as required by the Artemis quest, " +
                        "because there can't be a minimal element in an empty heap.");
        assertThrows(RuntimeException.class, () -> heap.deleteMin(studentResult),
                "Please throw an exception as required by the Artemis quest, " +
     ...
     * The task on Artemis states that the code must complete 5,000 operations in
     * under 2 seconds.
     * The 700 millisec comes from <a href =
     * "https://zulip.in.tum.de/#narrow/stream/1727-GAD-W08-Binomial-Heap/topic/Timeout/near/1057435">this
     * Zulip</a> message.
